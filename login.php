...
if(isset($_POST["lgbtn"]))
{
	...
	if($utype=="Admin")
	{
		$q="select * from user_table where Username=? and Password=?";
		$rs=$con->prepare($q);
						...
						<div class="box-body">
							...
							<form name="f1" method="post" action="login.php">
								...
								<div class="form-group text-right">
									<button name="lgbtn" class="btn btn-primary btn-block">Login</button>
								</div>
								<div class="form-group text-center">
									<span class="text-muted">If not Registered?</span> <a href="register.php">Register here</a>
								</div>
