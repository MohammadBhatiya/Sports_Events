...
if(isset($_POST["getbtn"]))
{
	...
	if($utype=="Admin")
	{
		$q="select password from user_table where Email_id=?";
		$rs=$con->prepare($q);
...
$mail->Port=587;
$mail->Username='spardha.gecd@gmail.com';
$mail->Password='012032043';
$mail->setFrom('spardha.gecd@gmail.com','SPARDHA SportEvent');
//$mail->addReplyTo('email','name');
$mail->Subject="Password Recovery From SPARDHA";
...
{
	echo "<script type='text/javascript'>alert('Password sent on Your Email id');</script>";
	...
	{
			echo "<script type='text/javascript'>alert('Plz Select User Type');</script>";
						...
						<div class="box-body">
							...
							<form method="POST" action="forgot.php">
								...
								<div class="form-group text-right">
									<button name="getbtn" class="btn btn-primary btn-block">Get Password</button>
								</div>
